...
// Table Headings
    ...
    'TABLE_HEADING_UNIT_PRICE_NET' => 'Unit Price (excl)',   //- Also used for add/update product modals
    'TABLE_HEADING_UNIT_PRICE_GROSS' => 'Unit Price (incl)',   //- Also used for add/update product modals
...
// Success, Warning, and Error Messages
    ...
    'ERROR_DISPLAY_PRICE_WITH_TAX' => 'You have configured Zen Cart to display prices with' . (zen_config('DISPLAY_PRICE_WITH_TAX_ADMIN') !== 'true' ? 'out ' : ' ') . 'tax. This page is currently displaying prices with' . (zen_config('DISPLAY_PRICE_WITH_TAX') !== 'true' ? 'out ' : ' ') . 'tax. Orders cannot be edited until the two settings are the same.',
