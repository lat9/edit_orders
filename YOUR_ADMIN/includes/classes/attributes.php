...
class attributes extends base {
     ...
     * @return array
     */
    public function get_attribute_options_values_by_type($zf_product_id, $options_type = PRODUCTS_OPTIONS_TYPE_READONLY) {
        global $db;
     ...
     * @return array
     */
    public function get_attribute_options_values_by_option($zf_product_id, $options_id) {
        global $db;
        $query = 'SELECT attr.products_attributes_id, attr.products_id, attr.options_id, val.products_options_values_name ' .
            'FROM ' . TABLE_PRODUCTS_ATTRIBUTES . ' AS attr ' .
            'LEFT JOIN ' . TABLE_PRODUCTS_OPTIONS .
     ...
     * @return array
     */
    public function get_attribute_options_names_by_type($zf_product_id, $options_type = PRODUCTS_OPTIONS_TYPE_READONLY) {
        global $db;
    ...
    */
    public function get_attribute_options_name_by_option($options_id) {
        global $db;
     ...
     * @return array
     */
    public function get_attributes_options_by_type($zf_product_id, $options_type = PRODUCTS_OPTIONS_TYPE_READONLY) {
        global $db;
     ...
     * @return array
     */
    public function get_attributes($zf_product_id, $readonly = false) {
        global $db;
     ...
     * @return array
     */
    public function get_attributes_by_option($zf_product_id, $zf_option_id, $key_format = 'database') {
        global $db;
        $query = 'SELECT attr.*, opt.products_options_name, val.products_options_values_name, opt.products_options_type ' .
            'FROM ' . TABLE_PRODUCTS_ATTRIBUTES . ' AS attr ' .
            'LEFT JOIN ' . TABLE_PRODUCTS_OPTIONS .
